    ...
    try {
        ...
        if (error.response && error.response.data) {
            if (error.response.data.detail) {
                ...
                // Try to extract the first error value if it's a dict
        ...
        dispatch({
            ...
            payload: errorMsg === 'No active account found with the given credentials' ? 'Login yoki parol noto\'g\'ri kiritildi' : errorMsg
        })
    }
}
