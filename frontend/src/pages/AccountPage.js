                ...
                <div>
                    ...
                    <Container>
                        <Row className="mr-6 mb-2 border border-dark">
                            <Col xs={4} md={2} className="p-3 bg-info text-white">Name:</Col>
                            <Col className="p-3">{userAccDetails.username}</Col>
                        </Row>
                        <Row className="mb-2 border border-dark">
                            <Col xs={4} md={2} className="p-3 bg-info text-white">Email:</Col>
                            <Col className="p-3">{userAccDetails.email}</Col>
                        </Row>
                        <Row className="mb-2 border border-dark">
                            <Col xs={4} md={2} className="p-3 bg-info text-white">Admin Privileges:</Col>
